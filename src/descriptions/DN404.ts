...
export const LAICOS_DN404=`Laicos use DN404 standard to generate tokens, ${DN404_DEFINE}`
export const LAICOS_DEFINE_FAIRLAUNCH="When achieve 100% of the bonding curve ~$69k Market Cap and use the raised liquidity to launch projects on DEX (Uniswap), driving potential exponential growth."
