export const DN404_DEFINE =
  'DN-404 is a token standard that combines the features of fungible and non-fungible tokens, enabling the creation of unique, shareable, and fractionalized assets. This makes NFTs more accessible and tradable. DN-404 tokens can be traded as both ERC-20 and ERC-721 assets.';
export const LAICOS_DN404 = `Laicos integrates ERC-721, ERC-1155, and DN-404 as core NFT standards. ${DN404_DEFINE}`;
export const LAICOS_DEFINE_FAIRLAUNCH =
  'Laicos Launchpad offers a fair and transparent ERC-721, ERC-1155 and DN-404 (DN-404 tokens can be traded as both ERC-20 and ERC-721 assets). Through mechanism pool, liquidity is generated as more tokens are purchased, ensuring sustainable growth and accessibility. Early supporters gain exclusive access to fractionalized NFTs, governance participation, and future profit-sharing, creating long-term value and engagement for the community.';
