...
// DASHBOARD: ECOMMERCE
export const DN404Fairlaunch = Loadable(lazy(() => import('../pages/dashboard/DN404Fairlaunch')));
export const DN404DetailsPage = Loadable(lazy(() => import('../pages/dashboard/DN404DetailsPage')));
...
// DASHBOARD: INVOICE
export const DN404TradeHistory = Loadable(
  lazy(() => import('../pages/dashboard/DN404TradeHistory'))
);
