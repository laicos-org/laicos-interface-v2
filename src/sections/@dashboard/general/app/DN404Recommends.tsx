// @mui
import { Box, Card, Rating, Button, CardHeader, Typography, Stack, CardProps } from '@mui/material';
// utils
...
export default function DN404Recommends({ title, subheader, list, ...other }: Props) {
  return (
    <Card {...other}>
...
function ApplicationItem({ app }: ApplicationItemProps) {
  const { shortcut, system, price, rating, review, name, tag } = app;
